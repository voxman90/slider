...
const className = {
  TOOLTIP: `slider__${ELEM_NAME}`,
};

const modifier = {
  VISIBLE: `${className.TOOLTIP}_visible`,
  ORIENTATION_HORIZONTAL: `${className.TOOLTIP}_orientation_horizontal`,
  ORIENTATION_VERTICAL: `${className.TOOLTIP}_orientation_vertical`,
};

class Tooltip extends SliderElement {
